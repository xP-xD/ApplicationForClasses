...
public class PApplicationForClasses {
	...
	public void show(Scanner scanner, VPersonalInfo vPersonalInfo) {
		...
		System.out.println(vPersonalInfo.getName() + "님, 안녕하세요!");
		...
		while (!finished == true) {
			...
			Vector<VPreApplicationForClasses> vPreApplicationForClasses = sPreApplicationForClasses
					.getData(vPersonalInfo.getId());
			if (vPreApplicationForClasses != null) {
